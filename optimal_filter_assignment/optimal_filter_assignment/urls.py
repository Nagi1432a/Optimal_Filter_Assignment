"""optimal_filter_assignment URL Configuration
...
from optimal_filter_assignment import settings
...
urlpatterns = [
    ...
    url(r'^View_Attack_Type_Ratio/$', serviceprovider.View_Attack_Type_Ratio, name="View_Attack_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Attack_Type/$', serviceprovider.View_Prediction_Of_Attack_Type, name="View_Prediction_Of_Attack_Type"),
