...
--
-- Host: localhost
-- Generation Time: Jan 31, 2023 at 01:03 PM
...
--
-- Database: `optimal_filter_assignment`
--
CREATE DATABASE IF NOT EXISTS `optimal_filter_assignment` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `optimal_filter_assignment`;
...
(5, 'Extra Tree Classifier', '88.26405867970661'),
(6, 'SVM', '89.73105134474328'),
(7, 'Logistic Regression', '89.48655256723717'),
(8, 'Gradient Boosting Classifier', '89.97555012224939');
...
(15, 'DDoS-PSH-ACK', '75.0'),
(16, 'Flooding attack', '25.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_attack_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_attack_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(300) NOT NULL,
  `ip_src` varchar(300) NOT NULL,
  `ip_dst` varchar(300) NOT NULL,
  `tcp_srcport` varchar(300) NOT NULL,
  `tcp_dstport` varchar(300) NOT NULL,
  `tcp_flags_push` varchar(300) NOT NULL,
  `tcp_flags_ack` varchar(300) NOT NULL,
  `tcp_ack` varchar(300) NOT NULL,
  `frame_time` varchar(300) NOT NULL,
  `packets_bytes` varchar(300) NOT NULL,
  `tx_packets` varchar(300) NOT NULL,
  `tx_bytes` varchar(300) NOT NULL,
  `rx_packets` varchar(300) NOT NULL,
  `rx_bytes` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_predict_attack_type`
--

INSERT INTO `remote_user_predict_attack_type` (`id`, `RID`, `ip_src`, `ip_dst`, `tcp_srcport`, `tcp_dstport`, `tcp_flags_push`, `tcp_flags_ack`, `tcp_ack`, `frame_time`, `packets_bytes`, `tx_packets`, `tx_bytes`, `rx_packets`, `rx_bytes`, `Prediction`) VALUES
(1, '10.42.0.211-103.235.46.212-46124-443-6', '192.168.1.1', '192.168.23.2', '2416', '8000', '1', '1', '1', ' 16-Jun 2020 20:18:15.071159000 Mountain Daylight Time', '12', '5', '324', '6', '324', 'DDoS-PSH-ACK'),
(2, '10.42.0.211-10.42.0.1-58632-53-17', '192.168.1.1', '192.168.23.2', '2429', '8000', '1', '1', '1', ' 16-Jun 2020 20:18:15.071437000 Mountain Daylight Time', '10', '5', '270', '5', '270', 'Flooding attack'),
(3, '10.42.0.211-23.206.125.17-50438-80-6', '192.168.1.1', '192.168.23.2', '2430', '8000', '1', '1', '1', ' 16-Jun 2020 20:18:15.071444000 Mountain Daylight Time', '8', '4', '216', '4', '216', 'DDoS-PSH-ACK'),
(4, '172.217.3.104-10.42.0.211-443-50066-6', '192.168.1.1', '192.168.23.2', '2726', '8000', '1', '1', '1', ' 16-Jun 2020 20:18:15.083130000 Mountain Daylight Time', '6', '3', '162', '3', '162', 'DDoS-PSH-ACK');
